...
('anatomia', 'anatomia', 'Anatomia', 'Exploração das estruturas do corpo humano e sua organização sistêmica.'),
...
('fisiologia', 'fisiologia', 'Fisiologia', 'Compreensão do funcionamento normal do corpo humano e seus mecanismos de regulação.'),
